...
const ClassButton = styled.button`
   ...
   background: ${props => (props.active ? "#7469B6" : "white")}; /* Change background color */
   color: ${props => (props.active ? "white" : "black")}; /* Change text color */
   ...
   cursor: pointer;
   &:hover {
      background: ${props => (props.active ? "#7469B6" : "#7469B6")}; /* Keep background color on hover if active */
      color: white;
   }
`
         ...
         <>
             ...
             <Center>
                 ...
                 <SortDropDown onClose={handleSortClickOutside} icon={
                     ...
                     <Sort chooseType={handleSortTypeChoose} sortProducts={sortProducts}/>
                 </SortDropDown>
