...
export default function Buttons({ onRecentlyAddedClick, onAllClick }) {
    ...
    return (
        <Center>
            <StyledButton clicked={isClickedAll} onClick={handleClickAll}>Всі матеріали</StyledButton>
            <StyledButton clicked={isClicked} onClick={handleClick}>Недавно додані</StyledButton>
        </Center>
    );
}
