...
export default function Product(prodactImg,productName, productCost) {
    return (
        <Center>
            <StyledProduct>
                <StyledPNG src="/image.png" alt="Product Image" />
                <StyledName>Презентація 8 клас</StyledName>
                <StyledCost>100 UAH</StyledCost>
                <StyledAddToCart>
